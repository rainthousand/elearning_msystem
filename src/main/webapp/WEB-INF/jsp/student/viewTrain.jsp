        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h1 style="text-align: center;">View Training</h1>
                    </div>
                </div>
                <%--                <div class="content">--%>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/student/viewTrain" id="editfrom" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input onmouseover="this.style.borderColor='black';this.style.backgroundColor='#fff4f3'"
                                       style="width: 106; height: 21"
                                       onmouseout="this.style.borderColor='black';this.style.backgroundColor='#ffffff'" style="border-width:1px;border-color:black" readonly="readonly" type="text" class="form-control" id="inputPassword3" name="courseid" value="${training.courseid}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input onmouseover="this.style.borderColor='black';this.style.backgroundColor='#fff4f3'"
                                       style="width: 106; height: 21"
                                       onmouseout="this.style.borderColor='black';this.style.backgroundColor='#ffffff'" style="border-width:1px;border-color:black" readonly="readonly" type="text" class="form-control" id="inputPassword4" name="trdescription" value="${training.trdescription}">
                            </div>
                        </div>
                        <%--							  <div class="form-group">--%>
                    ...
                    <button class="btn btn-default" style="display:block;margin:0 auto" onClick="location.href='${pageContext.request.contextPath}/student/showTrain'">Back</button>
                </div>
            </div>

            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <%--                </div>--%>
                        <h1 class="col-md-5">Training List</h1>
                    </div>
                </div>
                <table class="table table-bordered">
                    ...
                    <c:forEach  items="${trainList}" var="item">
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-default btn-xs btn-info" onClick="location.href='${pageContext.request.contextPath}/student/viewTrain?id=${item.trainid}'">View</button>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
